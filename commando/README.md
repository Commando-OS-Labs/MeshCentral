...
- Caddy: public TLS for the console and broker. MongoDB and both application containers remain private.
...
- Two DNS records pointing to the VPS: a console host and a broker host.
